...
import wh.tb.crxyspider.model.annotation.*;
import wh.tb.crxyspider.model.formatter.BasicTypeFormatter;
import wh.tb.crxyspider.model.formatter.ObjectFormatter;
import wh.tb.crxyspider.model.formatter.ObjectFormatters;
import wh.tb.crxyspider.selector.*;
import wh.tb.crxyspider.utils.ClassUtils;
import wh.tb.crxyspider.utils.ExtractorUtils;
...
class PageModelExtractor {
    ...
    public static wh.tb.crxyspider.model.PageModelExtractor create(Class clazz) {
        wh.tb.crxyspider.model.PageModelExtractor pageModelExtractor = new wh.tb.crxyspider.model.PageModelExtractor();
    ...
    private Object processSingle(Page page, String html, boolean isRaw) {
        ...
        try {
            ...
            if (wh.tb.crxyspider.model.AfterExtractor.class.isAssignableFrom(clazz)) {
