...
public abstract class BasicTypeFormatter<T> implements ObjectFormatter<T> {
    ...
    public static class IntegerFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Integer> {
        @Override
    ...
    public static class LongFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Long> {
        @Override
    ...
    public static class DoubleFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Double> {
        @Override
    ...
    public static class FloatFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Float> {
        @Override
    ...
    public static class ShortFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Short> {
        @Override
    ...
    public static class CharactorFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Character> {
        @Override
    ...
    public static class ByteFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Byte> {
        @Override
    ...
    public static class BooleanFormatter extends wh.tb.crxyspider.model.formatter.BasicTypeFormatter<Boolean> {
        @Override
