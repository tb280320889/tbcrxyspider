...
class ModelPageProcessor implements PageProcessor {
    ...
    public static wh.tb.crxyspider.model.ModelPageProcessor create(Site site, Class... clazzs) {
        wh.tb.crxyspider.model.ModelPageProcessor modelPageProcessor = new wh.tb.crxyspider.model.ModelPageProcessor(site);
    ...
    public wh.tb.crxyspider.model.ModelPageProcessor addPageModel(Class clazz) {
