...
import wh.tb.crxyspider.selector.Json;
import wh.tb.crxyspider.selector.Selectable;
 ...
 * {@link #getResultItems()} get extract results to be used in {@link wh.tb.crxyspider.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(java.util.List)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @see wh.tb.crxyspider.downloader.Downloader
 * @see wh.tb.crxyspider.processor.PageProcessor
 * @since 1.0
 */
